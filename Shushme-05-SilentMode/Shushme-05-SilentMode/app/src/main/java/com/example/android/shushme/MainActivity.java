...
public class MainActivity extends AppCompatActivity implements
    ...
    public void onResume() {
        ...
        // Also since we don’t want the user to be unchecking this after permissions have been granted,
        // it's best to disable the checkbox once everything seems to be set properly.

        // initializes permission for the ringer on checkbox
        CheckBox ringerPermissions = (CheckBox) findViewById(R.id.ringer_permissions_checkbox);
        NotificationManager notificationManager = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
        // Check if the API supports such permission change and also check of its permission Granted process
    ...
    // First let’s add a checkbox to ask the user for RingerMode permissions, the onclick event
    // will launch an intent for ACTION_NOTIFICATION_POLICY_ACCESS_SETTINGS and start it.
