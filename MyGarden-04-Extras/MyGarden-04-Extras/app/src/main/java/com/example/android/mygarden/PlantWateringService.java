...
//        Uri PLANTS_URI = BASE_CONTENT_URI.buildUpon().appendPath(PATH_PLANTS).build();
    ...
    private void handleActionUpdatePlantWidgets() {
        ...
        Uri SINGLE_PLANT_URI = BASE_CONTENT_URI.buildUpon().appendPath(PATH_PLANTS).build();
        ...
        boolean needToWater = false;   // Default to hide the water drop from the button
        ...
        if (cursor != null && cursor.getCount() > 0) {
            ...
            needToWater = (timeNow-wateredAt)>PlantUtils.MIN_AGE_BETWEEN_WATER && (timeNow-createdAt)<PlantUtils.MAX_AGE_WITHOUT_WATER;
        ...
        PlantWidgetProvider.updatePlantWidgets(this, appWidgetManager, imgRes, plantId, needToWater, appWidgetIds);
    }
}
