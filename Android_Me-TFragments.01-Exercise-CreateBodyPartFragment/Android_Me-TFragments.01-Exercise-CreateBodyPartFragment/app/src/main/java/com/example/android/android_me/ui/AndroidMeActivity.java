...
public class AndroidMeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BodyPartFragment headImageFragment = new BodyPartFragment();

        // Using a FragmentManager to add the fragment to the screen by a Fragment Transaction.
        FragmentManager fragmentManager = getSupportFragmentManager();

        // Fragment Transaction taking place
        fragmentManager.beginTransaction()
                .add(R.id.head_image_container, headImageFragment)     // adding the Image fragment to the container
                .commit();
